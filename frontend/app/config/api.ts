export const API_CONFIG = {
  development: {
    ...
    CONVERT_CHUNKED_URL: 'http://localhost:5000/api/dify/convert/chunked',
    TEXT_CHUNKED_URL: 'http://localhost:5000/api/dify/convert/text-chunked',
  ...
  production: {
    ...
    CONVERT_CHUNKED_URL: 'https://smartdocx.jxchen.me/api/dify/convert/chunked',
    TEXT_CHUNKED_URL: 'https://smartdocx.jxchen.me/api/dify/convert/text-chunked',
